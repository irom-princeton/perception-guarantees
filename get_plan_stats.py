...
foldername = f'{base_path.parent}/nav_sim/sim_data/rooms_multiple/'
taskpath = f'{base_path.parent}/nav_sim/sim_data/task_multiple.pkl'

filename = 'cp_1.85.npz'
# pic_name = "cp1.85traj_plot.png"
