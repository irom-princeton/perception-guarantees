...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--save_path', default='/home/zm2074/Projects/data/perception-guarantees/task_1210_rot.pkl',
        nargs='?', help='path to save the task dataset'
    )
    parser.add_argument(
        '--task_folder', default='/home/zm2074/Projects/data/perception-guarantees/room_1210_rot',
